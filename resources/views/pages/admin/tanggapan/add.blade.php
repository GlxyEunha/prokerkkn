  ...
  <div class="container px-6 mx-auto grid">
    ...
    <form action="{{ route('tanggapan.store')}} " method="POST" enctype="multipart/form-data">
      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <button type="submit"
          class="mt-4 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-light-green border border-transparent rounded-lg active:bg-hover:bg-light-green hover:bg-hover:bg-light-green focus:outline-none focus:shadow-outline-green">
          Tanggapi
        </button>
      </div>
    </form>
