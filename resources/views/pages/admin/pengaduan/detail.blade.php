    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
      ...
      <div class="flex justify-center my-4">
        <a href="{{ url('admin/pengaduan/cetak', $item->id)}}"
          class="px-5 py-3 font-medium leading-5 text-white transition-colors duration-150 bg-light-green border border-transparent rounded-lg hover:bg-light-green focus:outline-none focus:shadow-outline-green">
          Export ke PDF
        </a>
      </div>
